...
start locator --name=locator --port=41111 --properties-file=gemfire-server.properties --initial-heap=50m --max-heap=50m --J=-Dgemfire.OSProcess.ENABLE_OUTPUT_REDIRECTION=true
