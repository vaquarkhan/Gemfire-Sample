...
# Add this classpath so servers will pick up the summing function class
export CLASSPATH=$CLASSPATH:../../target/classes

# Issue commands to gfsh to start locator and launch a server
echo "Starting locator and server for partitioned regons ..."
gfsh run --file=serverStartPartitioned.gf
...
echo "Loading data..."
# Engages the pdx profile, which will use PDX serialization
